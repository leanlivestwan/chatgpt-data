package cn.scalecraft.chatgpt.data.trigger.http;

import cn.scalecraft.chatgpt.data.domain.auth.model.entity.AuthStateEntity;
import cn.scalecraft.chatgpt.data.domain.auth.model.valobj.AuthTypeVO;
import cn.scalecraft.chatgpt.data.domain.auth.service.IAuthService;
import cn.scalecraft.chatgpt.data.domain.weixin.model.entity.MessageTextEntity;
import cn.scalecraft.chatgpt.data.domain.weixin.model.entity.UserBehaviorMessageEntity;
import cn.scalecraft.chatgpt.data.domain.weixin.model.valobj.MsgTypeVO;
import cn.scalecraft.chatgpt.data.domain.weixin.service.IWeiXinBehaviorService;
import cn.scalecraft.chatgpt.data.types.common.Constants;
import cn.scalecraft.chatgpt.data.types.model.Response;
import cn.scalecraft.chatgpt.data.types.sdk.weixin.XmlUtil;
